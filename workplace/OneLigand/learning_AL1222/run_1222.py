...
rc_al1213 = json_load(f"{_code_folder}/../learning_AL1213/reaction_collection_train_AL1213.json.gz")
rc_expt1222 = json_load(f"{_code_folder}/../collect/reaction_collection_AL1222.json.gz")

rc_train = L1XReactionCollection(rc_al1213.reactions + rc_expt1222.reactions)
rc_train_json = f"{_code_folder}/reaction_collection_train_AL1222.json.gz"
