...
rc_al1222 = json_load(f"{_code_folder}/../learning_AL1222/reaction_collection_train_AL1222.json.gz")
rc_expt0130 = json_load(f"{_code_folder}/../collect/reaction_collection_AL0130.json.gz")

rc_train = L1XReactionCollection(rc_al1222.reactions + rc_expt0130.reactions)
rc_train_json = f"{_code_folder}/reaction_collection_train_AL0130.json.gz"
