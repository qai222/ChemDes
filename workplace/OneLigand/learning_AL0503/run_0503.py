...
rc_al0331 = json_load(f"{_code_folder}/../learning_AL0331/reaction_collection_train_AL0331.json.gz")
rc_expt503 = json_load(f"{_code_folder}/../collect/reaction_collection_AL0503.json.gz")

rc_train = L1XReactionCollection(rc_al0331.reactions + rc_expt503.reactions)
rc_train_json = f"{_code_folder}/reaction_collection_train_AL0503.json.gz"
