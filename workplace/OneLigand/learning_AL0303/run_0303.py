...
rc_al0130 = json_load(f"{_code_folder}/../learning_AL0130/reaction_collection_train_AL0130.json.gz")
rc_expt0303 = json_load(f"{_code_folder}/../collect/reaction_collection_AL0303.json.gz")

rc_train = L1XReactionCollection(rc_al0130.reactions + rc_expt0303.reactions)
rc_train_json = f"{_code_folder}/reaction_collection_train_AL0303.json.gz"
